...
Here is presented steps to analysing data about  
bla-bla-bla  
bla-bla-bla  
...
Розподіл інвестицій та робочих місць за типом підприємства та регіоном {data-orientation=rows}
================================================================================

Row
--------------------------------------------------------------------------------

### Рейтинг типів підприємств за сумою інвестицій
...
### Рейтинг типів підприємств за кількістю робочих місць
...
### Рейтинг областей за сумою інвестицій
...
### Рейтинг областей за кількістю робочих місць
